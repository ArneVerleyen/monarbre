...
const PrivacyPolicy = () => {
    return (
        <div className="privacy_policy">
            ...
            <ol>
                <li>Deze privacy policy (“<strong>Privacy Policy</strong>”) behandelt de verwerking van uw persoonsgegevens als een onderdeel van uw gebruik van onze Website (de “<strong>Website</strong>”) en de diensten die daarmee verband houden (gezamenlijk aangeduid als de “<strong>Diensten</strong>”). Deze verwerking wordt uitgevoerd door Mon Pijpstra als verwerkingsverantwoordelijke, met zetel te Sint-Ursmarusstraat 38 bus 6, 9200 Baasrode (“<strong>wij</strong>”, “<strong>ons</strong>”), ingeschreven in de KBO onder nummer BE 0775.318.624, in overeenstemming met de toepasselijke wetgeving inzake de bescherming van persoonsgegevens.</li><li>Door de checkbox aan te vinken waarin vermeld wordt dat u de Privacy Policy volledig hebt gelezen en begrepen en dat er zonder voorbehoud mee instemt, geeft u toestemming om uw persoonsgegevens te verwerken zoals uiteengezet in deze Privacy Policy, en verklaart u dat u inderdaad deze Privacy Policy gelezen heeft en hiermee zonder voorbehoud instemt. U verklaart dat u begrijpt met welke doeleinden uw persoonsgegevens worden verwerkt. U stemt er ook mee in dat uw voortgezet gebruik wordt begrepen als een voortgezette toestemming. U kan uw toestemming op elk ogenblik intrekken door contact op te nemen met ons via ons contact formulier.</li>
                <li>Wij behouden ons het recht voor om de Privacy Policy van tijd tot tijd te kunnen wijzigen volgens ons eigen inzicht. Dergelijke wijzigingen zullen via de Website gecommuniceerd worden.</li>
                <li>Deze Privacy Policy werd het laatst bijgewerkt op 7-5-2022.&nbsp;</li>
            </ol>
            
            <h4>2. Wat &amp; waarom we gegevens verwerken</h4>
            
            <ol>
                <li>Wanneer u de Website en/of Diensten gebruikt, verwerken we persoonsgegevens die op u betrekking hebben. Uw persoonsgegevens worden verwerkt ten behoeve van de volgende doeleinden (telkens met vermelding van de rechtsgronden), waaronder:</li>
            </ol>
            
            <p><strong>Wanneer en op welke basis?&nbsp;</strong></p>
            
            <ul>
                <li>Gebruik van de Website (toestemming en indien van toepassing legitiem belang)&nbsp;</li>
                <li>Ons contacteren (toestemming en indien van toepassing legitiem belang)&nbsp;</li>
            </ul>
            
            <p><strong>Welke?</strong></p>
            
            <ul>
                <li>Identificatiegegevens (naam, adres, e-mail, telefoon,..)</li>
            ...
            <ul>
                <li>Het verbeteren van de gebruikservaring&nbsp; van de bezoeker op de website</li>
                <li>Gevolg geven aan verzoek tot contact</li>
            </ul>
            
            <ol>
                <li>In principe verkrijgen wij de hierboven genoemde persoonsgegevens rechtstreeks van u.&nbsp;</li>
                <li>Wij sturen in principe geen van de persoonlijke gegevens die u via de Website verstrekt door aan providers van social media, tenzij u hiermee instemt.&nbsp;</li>
                <li>Naast de bovengenoemde doeleinden kunnen wij uw persoonlijke gegevens ook verwerken:</li>
            </ol>
            ...
            <ul>
                ...
                <li>Om uw persoonsgegevens te verwerken zodat wij u bepaalde Diensten kunnen verstrekken.</li>
                ...
                <li>In het kader van een mogelijke fusie met, overname van/door of splitsing door een derde partij, zelfs indien die derde zich buiten de EER bevindt.</li>
            </ul>
            
            <h4>3. Met wie wij gegevens delen</h4>
            
            <ol>
                <li>Wij verzenden uw persoonsgegevens niet op een identificeerbare manier naar derden als dit niet vereist is voor de werking van de Website en/of om de Diensten te verlenen, zonder uw uitdrukkelijke toestemming daartoe.&nbsp;</li>
            ...
            <h4>4. Waar wij gegevens verwerken</h4>
            
            <ol>
                <li>Wijzelf en onze externe verwerkers zullen uw identificeerbare persoonsgegevens alleen in de EER verwerken.</li>
                <li>Wij kunnen uw geanonimiseerde en/of geaggregeerde gegevens overdragen aan organisaties buiten de EER. Indien een dergelijke overdracht plaatsvindt, zullen wij ervoor zorgen dat er passende waarborgen zijn om de veiligheid en integriteit van uw persoonlijke gegevens te garanderen, en dat alle rechten met betrekking tot persoonsgegevens gegarandeerd worden die u zou kunnen genieten onder toepasselijk dwingend recht en wordt het nodige wettelijk beschermingsmechanisme ingevoerd.&nbsp;</li>
            </ol>
            
            <h4>5. Hoe wij gegevens verwerken</h4>
            
            <ol>
                <li>Wij zullen ons uiterste best doen om alleen de persoonsgegevens te verwerken die nodig zijn om de in deze Privacy Policy vermelde doeleinden te bereiken. Wij zullen uw persoonsgegevens op een wettelijke, eerlijke en transparante manier verwerken. Wij zullen ons uiterste best doen om de persoonsgegevens accuraat en up-to-date te houden.</li>
                ...
                <li>Wij zullen de gepaste technische en organisatorische maatregelen nemen om uw persoonsgegevens veilig te houden tegen ongeoorloofde toegang of diefstal en tegen onopzettelijk verlies, manipulatie of vernietiging. Toegang door ons personeel of personeel van onze externe verwerkers is alleen mogelijk op een need-to-know-basis en is onderworpen aan strikte geheimhoudingsverplichtingen. U begrijpt echter dat de zorg voor veiligheid en beveiliging slechts inspanningsverplichtingen naar beste vermogen zijn, die nooit kunnen worden gegarandeerd.</li>
            ...
            <h4>6. Hoe lang bewaren jullie mijn gegevens?</h4>
            
            <p>De bewaartermijnen variëren afhankelijk van de aard van de verleende dienst. We bewaren je gegevens:</p>
            
            <ul>
                <li>zo lang als nodig voor de doeleinden waarvoor ze worden verzameld en verwerkt.</li>
                <li>zo lang ze nodig zijn om onze wettelijke, contractuele en juridische verplichtingen na te leven en te voldoen aan onze commerciële operationele activiteiten.</li>
            </ul>
            
            <h4>7. Uw rechten</h4>
            
            <ol>
                <li>U heeft het recht om toegang te vragen tot alle persoonsgegevens die wij over u verwerken. Verzoeken om toegang die klaarblijkelijk worden ingediend met oog op het veroorzaken van overlast of schade voor ons, worden echter niet behandeld.</li>
                <li>U heeft het recht om te vragen dat alle persoonsgegevens over u die onjuist of onnauwkeurig zijn, kosteloos worden gecorrigeerd. Als u zich heeft geregistreerd op onze Website, kunt u veel van deze gegevens zelf corrigeren via uw profiel. Indien een dergelijk verzoek wordt ingediend, dient u bij dit verzoek ook het bewijs te voegen dat de persoonsgegevens waarvoor correctie wordt gevraagd, onjuist zijn.</li>
                <li>U heeft het recht om uw eerder gegeven toestemming voor de verwerking van uw persoonsgegevens in te trekken. U kunt uw toestemming te allen tijde intrekken door een e-mail te sturen naar <a href="mailto:info@mon-arbre.be">info@mon-arbre.be</a>, of door uw profiel te verwijderen (indien van toepassing).&nbsp;</li>
